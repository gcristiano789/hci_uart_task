 ...
 *   3   /sw-pwm
 */
#define DT_N_FOREACH_CHILD(fn) fn(DT_N_S_chosen) fn(DT_N_S_aliases) fn(DT_N_S_soc) fn(DT_N_S_sw_pwm) fn(DT_N_S_cpus) fn(DT_N_S_leds) fn(DT_N_S_pwmleds) fn(DT_N_S_buttons)
 ...
 *
 * Node's generated path identifier: DT_N_S_pwmleds_S_pwm_led_1
 *
 * Binding (compatible = pwm-leds):
 *   $ZEPHYR_BASE\dts\bindings\led\pwm-leds.yaml
 *
 ...
 *
 * Node's generated path identifier: DT_N_S_pwmleds_S_pwm_led_2
 *
 * Binding (compatible = pwm-leds):
 *   $ZEPHYR_BASE\dts\bindings\led\pwm-leds.yaml
 *
...
#define DT_N_S_soc_S_uart_40002000_P_rx_pin 19
